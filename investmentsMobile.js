...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupMobileTable() {
        ...
        rows.forEach(row => {
            // CRITICAL FIX: Skip purchase sub-rows — they have a different column structure
            // and are already handled by investmentsPage.js click logic.
            if (row.classList.contains('purchases-row') || row.classList.contains('purchase-detail-row')) return;
            ...
            // Clicking handled by investmentsPage.js (attachRowClickListeners)
